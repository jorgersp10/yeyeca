...
<section id="seccion">
        ...
        <div id="cabecera">
            <div class="Row">
                ...
                <img src="{{ public_path('assets/images/modafem.jpg') }}" alt="logo" height="70px" width="90px" /><br>
                    <strong style="text-align:center;" >Curupayty 337, Encarnación, Paraguay</strong> <br>
                    <strong style="text-align:center;" >Tel.: (0994) 855551 - (0975) 104951</strong> <br>
                </div>
