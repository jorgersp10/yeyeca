    ...
    <div class="row mb-4">
            <label class="col-md-3 col-form-label" for="telefono">Verificador</label>
            <div class="col-md-6">
                
                <input type="text" id="verificador" name="verificador" class="form-control" placeholder="Ingrese el codigo">
