                       ...
                       <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="float-end">
                                    <a href="{{URL::action('App\Http\Controllers\InformeController@pdfResumenMue')}}" target="_blank">
                                    ...
                                    <tbody>
                                         ...
                                         @foreach($cuotas as $c)
                                            ...
                                            <tr>                                    
                                                ...
                                                <td>{{$atraso}}</td>
                                                <td>                                     
                                                    <a href="{{URL::action('App\Http\Controllers\MuebleController@detalleCuotasMue', $c->mueble_id)}}">
                                                        <button type="button" class="btn btn-success btn-sm" >
