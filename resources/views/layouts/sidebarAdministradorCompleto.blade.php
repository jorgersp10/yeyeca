    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('cliente')}}" onclick="event.preventDefault(); document.getElementById('cliente-form').submit();"><i class="bx bxs-user-detail"></i> Clientes</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('user')}}" onclick="event.preventDefault(); document.getElementById('user-form').submit();"><i class="fas fa-people-arrows"></i> Usuarios</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('sucursal')}}" onclick="event.preventDefault(); document.getElementById('sucursal-form').submit();"><i class="bx bx-map"></i> Sucursales</a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('inmueble')}}" onclick="event.preventDefault(); document.getElementById('inmueble-form').submit();"><i class="bx bx-map"></i> Inmuebles</a>
                    <form id="inmueble-form" action="{{url('inmueble')}}" method="GET" style="display: none;">
                        {{csrf_field()}} 
                        </form> 
                </li>  

                <li class="nav-item">
                    <a class="nav-link" href="{{url('venta')}}" onclick="event.preventDefault(); document.getElementById('venta-form').submit();"><i class="bx bx-money"></i> Venta Inmuebles</a>
